...
extern void SysCtlBrownOutConfigSet(unsigned long ulConfig, unsigned long ulDelay);
...
extern unsigned long SysCtlI2SMClkSet(unsigned long ulInputClock, unsigned long ulMClk);
